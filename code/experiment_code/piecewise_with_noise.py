...
# Piecewise relationship with noise
x = np.linspace(-5, 5, 100)
y_clean = piecewise_function(x)
# Add noise to y
...
plt.plot(x, y_clean, 'r-', linewidth=2, label='Piecewise function (clean)')
